...
* 第三题涉及到BFS和图，我好久没做了有些生疏，犯了一些错误，比如还**试图用DP表示路径**。这道题关键是考虑到复杂度，然后发现每个点只访问一次就行了，也就是**多源BFS**，天然保持了顺序；542题也是同一个思想
...
**Bieekly Contest 111 & Weekly Contest 359**
1. 双周赛第二题实际上双指针，但我当成dfs来写了，但本质上一样；双指针然后计数的思想可以适用于No.1782
2. 双周赛第三题也是经典选或不选DP了，注意多练习下递推写法
3. 双周赛第四题是数位DP，又没做出来，还是对条件理解不够深啊
4. 周赛第三题有很多类似题目了，二分+DP最好，但值域然后map也可以
5. 周赛第四题是分类后滑动窗口，需要一些思考才知道如何滑动窗口
6. 总体来说不难，但还是需要点思维和灵性，继续努力训练

**Weekly Contest 360**
* 第四题学到了**树上倍增/LCA**算法

**Bieekly Contest 112 & Weekly Contest 361**
1. 双周赛第一第二题判断任意排序后是否相同的情况，判断方法是**判断数目是否相同**
2. 双周赛第四题**组合数学**，当然更重要的是逻辑
3. 周赛第二题是发现规律，第三题是前缀和加哈希表，有些思维
4. 周赛第四题又是一个树上倍增，判断LCA

**Bieekly Contest 113 & ~~Weekly Contest 363~~**
1. 双周赛第二题，很巧妙的**贪心**题，我还是缺少了点灵性
2. 双周赛第三题，枚举题，我思考范围还是小了点
3. 双周赛第四天，换根dp/rerooting，可以好好总结
4. 这场双周赛质量不错，总结的教训是我还是要多练习

**Weekly Contest 364**
* 周赛第三题，难点是要想到使用单调栈和如何利用，如果有单调性的话可以联想到单调性
* 周赛第四题，TODO...

**Bieekly Contest 114 & Weekly Contest 365**
1. 双周赛第一题可以优化空间复杂度，利用**值域范围小**的特点，可以用**位**运算将**标志**存到一个**数**中
2. 双周赛第二题是**贪心**，在可以用3和2整除的情况下，要多利用3，可证明
3. 双周赛第三题同样是**贪心**，同时要利用**题目的性质(位运算&的特点)**，&的结果会越来越小，从而推理，关键是**思维**
4. 双周赛第四题直接可以利用**后序遍历**，也是**思维推理**
5. **思维推理**很重要
6. 周赛第三题是见过的，环形数组求和
7. 周赛第四题是内向基环树，可以用拓扑排序来做，可学习的新题型
